	...
	if(!empty($email) && !empty($password) && !is_numeric($email))
	{
		...
		if($result && mysqli_num_rows($result) > 0)
		{
			...
			if($user_data['password'] === $password)
			{
				...
				header("Location: parents_wall.php");
				$stmt = null;
			}
			else{
				$stmt = null;
...
<body>
	...
	<header>
		<img src="img/logo.png" width="236">
		<ul id="ul">
			<i class='bx bxs-x-circle closeBurger' onclick="toggleMenu()"></i>
	...
	<main>
		<h2>Welcome to your autism support network!</h2>
		<div class="container">
